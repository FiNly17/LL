...
{
	public class RegistrationViewModel : ViewModel, ICloseable, IDataErrorInfo
	{
		...
		private void ProcessRegistration()
		{
			...
			var (result, error) = UserManager.Register(Login, Password, EMail, Phone, Surname, Name, MiddleName, Address);
			if (result)
			{
